      ...
      <div className="w-1/2 flex flex-col items-start justify-between pl-6 lg:w-full lg:pl-0 lg:pt-6">
        ...
        <div className="mt-2 flex items-center">
          ...
          <Link
            href={link}
            target="_blank"
            className="ml-4 rounded-lg bg-dark text-light p-1 px-5 text-lg font-semibold dark:bg-light dark:text-dark 
          ...
          <div className="grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-14 lg:gap-x-7 md:gap-y-16 sm:gap-x-0  ">
            <div className="col-span-12">
              <FeaturedProject
                ...
                all the cryptocurrency. You can easily convert the price in your 
                local currency."
                link="/"
